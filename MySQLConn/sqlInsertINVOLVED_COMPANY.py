...
def Insert_Company(entry_id, game_id, company, developer, publisher):
    ...
    insert_stmt = ("INSERT INTO INVOLVED_COMPANY"
            "(entry_id, game_id, company, developer, publisher) "
            "VALUES (%s, %s, %s, %s, %s)")

    data = (entry_id, game_id, company, developer, publisher)
